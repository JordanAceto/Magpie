...
int bsp_adc_config_spi_init()
{
    ...
    return reset_spi_and_en_periph_clk(bsp_pins_adc_cfg_spi_handle);
}
...
int bsp_adc_ch0_data_spi_init()
{
    ...
    return reset_spi_and_en_periph_clk(bsp_pins_adc_ch0_data_spi_handle);
}
...
int bsp_adc_ch1_data_spi_deinit()
{
    ...
    return MXC_SPI_Shutdown(bsp_pins_adc_ch1_data_spi_handle);
}
