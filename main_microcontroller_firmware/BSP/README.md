...
|------|------|----------|---------|-------------|----------------|------------|
| P0.0 | Output/high-Z | AF1 | SPIXF_SSO | FLASH memory Chip Select | 3.3V | TODO |
| P0.1 | Output/high-Z | AF1 | SPIXF_MOSI | FLASH memory MOSI | 3.3V | TODO |
| P0.2 | Input/high-Z | AF1 | SPIXF_MISO | FLASH memory MISO | 3.3V | TODO |
| P0.3| Output/high-Z | AF1 | SPIXF_SCK | FLASH memory clock | 3.3V | TODO |
...
| P0.8 | Input | GPIO | Pullup | BLE enable pushbutton, active LOW | 3.3V | BSP - pushbutton module |
...
| P0.11 | Output | GPIO |  | AFE channel 0 enable | 3.3V | Audio - AFE control module |
| P0.12 | Output | GPIO |  | AFE channel 1 enable | 3.3V | Audio - AFE control module |
...
| P0.22 | Output | GPIO |  | ADC clock divider reset | 1.8V | Audio - AD4630 module |
...
| P1.6 | Output | GPIO |  | ADC chip select enable | 1.8V | Audio - AD4630 module  |
